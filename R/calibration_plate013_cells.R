...
df <- read_excel("../excel files/apilimod bafilomycin plate 13/DD_Cells_013.xlsx")
...
bywell$Conc <- ifelse(bywell$Well == "B08" | bywell$Well == "C08", "100uM_L4992",
                      ifelse(bywell$Well == "F08" | bywell$Well == "G08"| bywell$Well == "G10" , "baf_L4992",
                                           ifelse(bywell$Well == "B09" | bywell$Well == "D09", "100uM_L7364",
                                                  ifelse(bywell$Well == "F09" | bywell$Well == "G09" , "baf_L7364",
                                           "none_U2OS"))))

df$Conc <- ifelse(df$Well == "B08" | df$Well == "C08", "100uM_L4992",
                      ifelse(df$Well == "F08" | df$Well == "G08" | df$Well == "G10", "baf_L4992",
                             ifelse(df$Well == "B09" | df$Well == "D09", "100uM_L7364",
                                    ifelse(df$Well == "F09" | df$Well == "G09" , "baf_L7364",
                                           "none_U2OS"))))
...
df$cell_line <- factor(df$cell_line, levels=c("U2OS", "L4992", "L7364"))
...
write.csv(df, "../excel files/apilimod bafilomycin plate 13/df_Cells_013.csv")
