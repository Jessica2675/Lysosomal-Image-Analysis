...
df <- read_excel("../excel files/apilimod bafilomycin plate 12/DD_Cells_012.xlsx")
...
bywell$Conc <- ifelse(bywell$Well == "B03" | bywell$Well == "C03", "100uM_L6004",
                      ifelse(bywell$Well == "D03" | bywell$Well == "E03" | bywell$Well == "F03", "baf_L6004", 
                             ifelse(bywell$Well == "D02" | bywell$Well == "E02", "DMSO_L6004",
                                    ifelse(bywell$Well == "C04" | bywell$Well == "D04", "DMSO_L2572",
                                           ifelse(bywell$Well == "E04" | bywell$Well == "F04", "100uM_L2572",
                                                  ifelse(bywell$Well == "E05" | bywell$Well == "F05" | bywell$Well == "D05", "baf_L2572",
                                           "none_U2OS"))))))

df$Conc <- ifelse(df$Well == "B03" | df$Well == "C03", "100uM_L6004",
                      ifelse(df$Well == "D03" | df$Well == "E03" | df$Well == "F03", "baf_L6004", 
                             ifelse(df$Well == "D02" | df$Well == "E02", "DMSO_L6004",
                                    ifelse(df$Well == "C04" | df$Well == "D04", "DMSO_L2572",
                                           ifelse(df$Well == "E04" | df$Well == "F04", "100uM_L2572",
                                                  ifelse(df$Well == "E05" | df$Well == "F05" | df$Well == "D05", "baf_L2572",
                                                         "none_U2OS"))))))
...
write.csv(df, "../excel files/apilimod bafilomycin plate 12/df_Cells_012.csv")
