...
df <- read_excel("../excel files/apilimod plate 7/DD_Cells_007.xlsx")
...
bywell$Conc <- ifelse(bywell$Well == "B02" | bywell$Well == "C02" | bywell$Well == "E02" , "DMSO_L6004",
                             ifelse(bywell$Well == "F02" | bywell$Well == "C03" | bywell$Well == "D03" ,"100uM_L6004", 
                                    ifelse(bywell$Well == "B04" | bywell$Well == "C04" | bywell$Well == "D04","DMSO_L2572",
                                           ifelse(bywell$Well == "B05" | bywell$Well == "C05" | bywell$Well == "D05","100uM_L2572", "none_U2OS"))))

df$Conc <- ifelse(df$Well == "B02" | df$Well == "C02" | df$Well == "E02" , "DMSO_L6004",
                      ifelse(df$Well == "F02" | df$Well == "C03" | df$Well == "D03" ,"100uM_L6004", 
                             ifelse(df$Well == "B04" | df$Well == "C04" | df$Well == "D04","DMSO_L2572",
                                    ifelse(df$Well == "B05" | df$Well == "C05" | df$Well == "D05","100uM_L2572", "none_U2OS"))))
...
df$cell_line <- factor(df$cell_line, levels=c("U2OS", "L6004", "L2572"))

bywell$Conc <- factor(bywell$Conc, levels=c("none", "DMSO", "100uM"))
bywell$cell_line <- factor(bywell$cell_line, levels=c("U2OS","L6004", "L2572"))

##############save df   ##but first make sure you remove the filter!!!! >:(
write.csv(df, "../excel files/apilimod plate 7/df_Cells_007.csv")
