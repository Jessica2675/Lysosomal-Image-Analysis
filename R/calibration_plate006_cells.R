...
df <- read_excel("../excel files/apilimod plate 6/DD_Cells_006.xlsx")
...
bywell$Conc <- ifelse(bywell$Well == "B02" | bywell$Well == "C02" | bywell$Well == "D02" , "DMSO_L4992",
                             ifelse(bywell$Well == "B03" | bywell$Well == "C03" | bywell$Well == "D03" ,"100uM_L4992", 
                                    ifelse(bywell$Well == "B04" | bywell$Well == "C04" | bywell$Well == "D04","DMSO_L3200",
                                           ifelse(bywell$Well == "B05" | bywell$Well == "C05" | bywell$Well == "D05","100uM_L3200", "none_U2OS"))))

df$Conc <- ifelse(df$Well == "B02" | df$Well == "C02" | df$Well == "D02" , "DMSO_L4992",
                      ifelse(df$Well == "B03" | df$Well == "C03" | df$Well == "D03" ,"100uM_L4992", 
                             ifelse(df$Well == "B04" | df$Well == "C04" | df$Well == "D04","DMSO_L3200",
                                    ifelse(df$Well == "B05" | df$Well == "C05" | df$Well == "D05","100uM_L3200", "none_U2OS"))))
...
write.csv(df, "../excel files/apilimod plate 6/df_Cells_006.csv")

# Change order of factors
df$Conc <- factor(df$Conc, levels=c("none", "DMSO", "100uM"))
df$cell_line <- factor(df$cell_line, levels=c("U2OS", "L4992", "L3200"))

bywell$Conc <- factor(bywell$Conc, levels=c("none", "DMSO", "100uM"))
bywell$cell_line <- factor(bywell$cell_line, levels=c("U2OS", "L4992", "L3200"))
