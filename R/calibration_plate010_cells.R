...
df <- read_excel("../excel files/apilimod bafilomycin plate 10/DD_Cells_010.xlsx")
...
bywell$Conc <- ifelse(bywell$Well == "B02" | bywell$Well == "C02", "DMSO_L10900",
                      ifelse(bywell$Well == "B03" | bywell$Well == "C03", "100uM_L10900", 
                             ifelse(bywell$Well == "E03" | bywell$Well == "F03" | bywell$Well == "G03", "baf_L10900",
                                    ifelse(bywell$Well == "B04" | bywell$Well == "C04", "DMSO_L7364",
                                           ifelse(bywell$Well == "B05" | bywell$Well == "C05", "100uM_L7364",
                                                  ifelse(bywell$Well == "E05" | bywell$Well == "F05" | bywell$Well == "G05", "baf_L7364",
                                                         ifelse(bywell$Well == "B06" | bywell$Well == "C06", "DMSO_L3200",
                                                                ifelse(bywell$Well == "B07" | bywell$Well == "C07", "100uM_L3200", "none_U2OS"))))))))

df$Conc <- ifelse(df$Well == "B02" | df$Well == "C02", "DMSO_L10900",
                      ifelse(df$Well == "B03" | df$Well == "C03", "100uM_L10900", 
                             ifelse(df$Well == "E03" | df$Well == "F03" | df$Well == "G03", "baf_L10900",
                                    ifelse(df$Well == "B04" | df$Well == "C04", "DMSO_L7364",
                                           ifelse(df$Well == "B05" | df$Well == "C05", "100uM_L7364",
                                                  ifelse(df$Well == "E05" | df$Well == "F05" | df$Well == "G05", "baf_L7364",
                                                         ifelse(df$Well == "B06" | df$Well == "C06", "DMSO_L3200",
                                                                ifelse(df$Well == "B07" | df$Well == "C07", "100uM_L3200", "none_U2OS"))))))))
...
df$cell_line <- factor(df$cell_line, levels=c("U2OS", "L10900", "L3200", "L7364"))

bywell$Conc <- factor(bywell$Conc, levels=c("none", "DMSO", "100uM", "baf"))
bywell$cell_line <- factor(bywell$cell_line, levels=c("U2OS", "L10900", "L3200", "L7364"))


##############save df   ##but first make sure you remove the filter!!!! >:(
write.csv(df, "../excel files/apilimod bafilomycin plate 10/df_Cells_010.csv")
