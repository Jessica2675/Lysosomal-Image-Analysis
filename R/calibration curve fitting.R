...
df <- read_excel("../excel files/apilimod plate 4/DD_Calibration_004.xlsx")
...
byWell$pH <- c(2.6, 3.45, 4.09, 4.5, "4.5HC", 4.9, 5.2, 5.5, 6.35, 7)
...
fitmodel <- nls(y ~ highGtoR + (lowGtoR - highGtoR)/(1 + exp((x - pKa)/slope)), start=list(highGtoR = 0.8, lowGtoR = 0.1, pKa = 4, slope = 0.3))
